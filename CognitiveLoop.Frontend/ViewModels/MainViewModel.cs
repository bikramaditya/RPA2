namespace FluentTest.ViewModels
{
    ...
    public class MainViewModel : ViewModel
    {
        ...
        private FunctionViewModel[] functionItems;
        ...
        private RoboViewModel _RoboViewModel;
        ...
        public RoboViewModel RoboViewModel
        {
            get
            {
                return this._RoboViewModel;
            }

            set
            {
                this._RoboViewModel = value;
                this.OnPropertyChanged(nameof(this.RoboViewModel));
            }
        }
        ...
        public FunctionViewModel[] FunctionItems
        {
            get
            {
                return this.functionItems ?? (this.functionItems = new[]
                {
                    FunctionViewModel.Create("Icons\\loop.png", "Icons\\loop.png", "Loop", "Group A"),
                    FunctionViewModel.Create("Icons\\if.png", "Icons\\if.png", "If/Else", "Group A"),
                    FunctionViewModel.Create("Icons\\extract.png", "Icons\\extract.png", "Extract", "Group A"),
                    FunctionViewModel.Create("Icons\\calc.png", "Icons\\calc.png", "Calc", "Group A"),
                    FunctionViewModel.Create("Icons\\assert.png", "Icons\\assert.png", "Assert", "Group A"),
                    FunctionViewModel.Create("Icons\\log.png", "Icons\\log.png", "Log", "Group B"),
                });
            }
        }
